...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView MiTextView = (TextView) findViewById(R.id.textView);
        MiTextView.setOnClickListener(new View.OnClickListener(){

            @Override

            public void onClick(View arg0) {
                Intent intento = new Intent(getApplicationContext(), RegisterActivity.class);
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    if(user.getDisplayName() != null)
                        Mensaje("HI " + user.getDisplayName().toString());
                        Mensaje(user.getEmail().toString());
